...
export default function SearchBar(props: SearchBarProps) {
  ...
  return (
    <>
      <div className={`w-full flex flex-row p-1 gap-1 shadow-card ${props.isSelector && isOpened ? "rounded-t-[28px]" : "rounded-full"} transition-all duration-500 items-center`}>
