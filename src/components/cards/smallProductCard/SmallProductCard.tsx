...
const SmallProductCard: React.FC<smallProductCardProps> = ({ imageUrl, productName, onClick = () => { } }) => {
  return (
    <button onClick={onClick} className="flex items-center justify-start w-[156px] h-[56px] p-[8px] shadow-[0_0_4px_1px_rgba(0,0,0,0.1),0_0_1px_0_rgba(0,0,0,0.5)] rounded-[12px] ">
      <img
        src={imageUrl}
        alt={productName}
